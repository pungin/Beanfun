...
const zhTW = {
  ...
  announcement: {
    ...
    close: '關閉',
    reopen: '查看',
    maplelinkLink: 'MapleLink',
    historyTitle: '公告紀錄',
    historyHint: '以下是所有公告，點擊即可重新閱讀。',
    stateRead: '已讀',
    stateUnread: '未讀',
    level: {
      info: '一般',
      forced: '重要',
      forcedEveryTime: '每次提醒',
    },
  },
  accountList: {
...
const enUS = {
  ...
  announcement: {
    ...
    historyHint: 'Every announcement published so far — open one to read it again.',
    stateRead: 'Read',
    stateUnread: 'Unread',
    level: {
      info: 'Info',
      forced: 'Important',
      forcedEveryTime: 'Every launch',
    },
  },
  accountList: {
